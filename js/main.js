...
const AUDIO_DETAIL = [
	{
		time: 10000,
		count: 2,
		startTimes: [1000, 5500],
		dialog: {
			Japanese: [
				"こ、これは…その…",
				"想定していたものと…違う気がするのですが…！"
			],
			English: [
				"Th-This is... It's...",
	...
	},
	{
		...
		dialog: {
			...
			English: [
				"N-No! I-I'm not averse to it or anything of the sort...",
				"H-However! I am not implying that I enjoy it either...!"
			],
			Chinese: [
				"不，不是！并不是讨厌…",
				"但是！也不能说是喜欢…！"
	...
	},
	{
		time: 12000,
		count: 2,
		startTimes: [1800, 7300],
		dialog: {
			Japanese: [
				"たしかに、私自身はかわいいものが好きですが…",
				"「かわいい」の対象が自分というのは…"
			],
			English: [
				"I mean, it is a fact that I appreciate cute things...",
				`But for me to be the one who is "cute"...`
			],
			Chinese: [
				"我确实喜欢可爱的东西…",
				"但是说我可爱的话就…"
	...
	},
	{
		...
		dialog: {
			...
			English: [
				"I... What I am saying is...! I wasn't...",
				"...presuming that to be the situation...!"
			],
			Chinese: [
				"那，那个…这种情况…",
				"完全没有想象过…！"
	...
	},
	{
		...
		dialog: {
			...
			English: [
				"A-Are you making fun of me, Sensei?",
...
const HITBOX = {
	headpat: { xMin: 800, xMax: 1460, yMin: -100, yMax: 420 },
	voiceline: { xMin: 820, xMax: 1700, yMin: 840, yMax: 1800 }
};
